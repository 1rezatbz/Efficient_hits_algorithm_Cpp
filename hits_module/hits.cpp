...
//int main() {
//    std::cout << " New Hits Rank is !" << std::endl;
//    hits_alg::HitsGraph reza (6, 10, {{0, 1}, {1, 0}, {1, 2}, {0, 2}, {2, 3}, {3, 2}, {4, 3}, {5, 3}, {4, 5}, {5, 4}});
//   auto hits = hits_alg::ParallelIterativeHits(reza, 100, 10 ^ (-6));
//   std::cout<< "hub :"  ;
//   for(auto i : std::get<0>(hits)){std::cout<< i << "  " ; };
//    std::cout<< std::endl  ;
//    std::cout<< "auth :"  ;
//   for(auto i :  std::get<1>(hits)){std::cout<< i << "  " ; };
//
//    return 0;
//}